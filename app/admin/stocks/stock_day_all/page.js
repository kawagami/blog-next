...
import { getStockDayAll } from "@/components/stocks/actions";
    ...
    return (
        <div className="w-full lg:w-4/5 max-h-[calc(100svh-180px)] overflow-auto p-6 bg-gray-100">
                ...
                <table className="min-w-full bg-white border border-gray-300 text-sm">
                    <thead className="bg-gray-200 sticky top-0 z-10">
                        <tr>
                            ...
                            <th className="px-3 py-2 border">名稱</th>
            ...
            <div className="flex gap-2 mt-4">
                {offset > 0 && (
                    <a
                        href={`?trade_date=${trade_date}&limit=${limit}&offset=${Math.max(0, offset - limit)}`}
                ...
                {data.length === limit && (
                    <a
                        href={`?trade_date=${trade_date}&limit=${limit}&offset=${offset + limit}`}
                        className="px-3 py-1 bg-gray-300 rounded text-sm hover:bg-gray-400"
                    >
                        下一頁
                    </a>
