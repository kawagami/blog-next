                    ...
                    <tbody>
                        {info.map((item) => (
                            <tr key={item.stock_no} className="hover:bg-gray-100">
                                ...
                                <td className={`px-4 py-2 border text-right ${parseFloat(item.diff) >= 0 ? 'text-green-600' : 'text-red-600'}`}>{item.diff}</td>
                                <td className={`px-4 py-2 border text-right ${parseFloat(item.diff_percent) >= 0 ? 'text-green-600' : 'text-red-600'}`}>{item.diff_percent}%</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
