        ...
        <header className="min-h-[50px] flex items-center justify-between px-4">
            ...
            <nav className={`sm:flex sm:items-center sm:gap-4 ${isOpen ? 'block' : 'hidden'}`}>
                ...
                <div className="relative group">
                    <button className="block px-4 hover:scale-110 hover:text-blue-400" aria-label="開啟 Resources 選單">Resources</button>
                    <div className="absolute left-0 bg-white shadow-lg rounded-md overflow-hidden hidden group-hover:block group-focus-within:block">
                        ...
                        <Link href="/countdown" className="block px-4 py-2 hover:bg-gray-100">Countdown</Link>
                        <Link href="/sango-calculate" className="block px-4 py-2 hover:bg-gray-100">SangoCalculate</Link>
                    </div>
                </div>
